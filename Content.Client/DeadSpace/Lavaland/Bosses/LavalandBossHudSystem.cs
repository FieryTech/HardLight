...
public sealed class LavalandBossHudSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        _cfg.OnValueChanged(CCVars.BossMusicEnabled, OnBossMusicEnabledChanged, true);
        _cfg.OnValueChanged(CCVars.BossMusicVolume, OnBossMusicVolumeChanged, true);
    }
    ...
    public override void Shutdown()
    {
        ...
        _cfg.UnsubValueChanged(CCVars.BossMusicEnabled, OnBossMusicEnabledChanged);
        _cfg.UnsubValueChanged(CCVars.BossMusicVolume, OnBossMusicVolumeChanged);
        ClearHud();
        ClearMusic();
    }
